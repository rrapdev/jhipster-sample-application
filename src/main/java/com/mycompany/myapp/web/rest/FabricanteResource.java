...
public class FabricanteResource {
    ...
    public FabricanteResource(FabricanteService fabricanteService, FabricanteRepository fabricanteRepository) {
    ...
    public ResponseEntity<List<FabricanteDTO>> getAllFabricantes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Fabricantes");
        Page<FabricanteDTO> page = fabricanteService.findAll(pageable);
