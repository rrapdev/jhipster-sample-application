...
export class FabricanteComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.fabricanteService
      ...
      .subscribe({
        next: (res: HttpResponse<IFabricante[]>) => {
  ...
  trackId(_index: number, item: IFabricante): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IFabricante[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
